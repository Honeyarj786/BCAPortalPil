<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Fest-bh.aspx.cs" Inherits="festival_bh" %>
...
<script>
    ...
    <p style="font-size: large; color: #FF0066"class="justify-text">
        <span class="style3" 
